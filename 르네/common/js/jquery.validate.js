...
jQuery.validator.setDefaults({
	...
	showErrors:function(errorMap, errorList){
		...
		$(errorList).each(function() {
			...
			if(errorCount == 0){
				var caption = $(element).attr('caption') || $(element).attr('name') || $(element).attr('title');
				alert('[' + caption + ']' + error);                       
				$(element).focus();
				errorCount++;
			}
...
jQuery.validator.setDefaults({
	...
	showErrors:function(errorMap, errorList){
		...
		$(errorList).each(function() {
			...
			if(errorCount == 0){
				var caption = $(element).attr('caption') || $(element).attr('title') || $(element).attr('name');
				alert('[' + caption + ']' + error);                       
				$(element).focus();
				errorCount++;
			}
...
$(document).ready(function() {
	...
	$('#searchform, #searchform2, #totalsearchform').validate({
		rules: {},
		messages: {},
		errorPlacement: function (error, element) {},
		submitHandler: function (form) { 
